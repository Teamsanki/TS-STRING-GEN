...
async def gen_session(
    ...
    try:
        ...
        return await Sanki.send_message(
            user_id,
    ...
    await Sanki.send_message(user_id, "» ᴛʀʏɪɴɢ ᴛᴏ sᴇɴᴅ ᴏᴛᴩ ᴀᴛ ᴛʜᴇ ɢɪᴠᴇɴ ɴᴜᴍʙᴇʀ...")
    if telethon:
        client = TelegramClient(StringSession(), api_id, api_hash)
    elif old_pyro:
        client = Client1(":memory:", api_id=api_id, api_hash=api_hash)
    else:
        client = Client(name="Sanki", api_id=api_id, api_hash=api_hash, in_memory=True)
    ...
    try:
        ...
        return await Sanki.send_message(user_id, f"ᴇʀʀᴏʀ : <code>{str(ex)}</code>")
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@cc_world_official"))
        else:
